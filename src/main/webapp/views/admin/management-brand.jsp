...
<head>
    <title>Sunshine - Admin - Brand</title>
            ...
            <%@include file="_header.jsp" %>
                                ...
                                <form id="validation-form" method="post" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate" data-parsley-priority-enabled="false">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label for="normal-field" class="col-sm-4 control-label">Brand ID</label>
                                            <div class="col-sm-5">
                                                <input type="number" id="transparent-field" value="${brand.brandID }" class="form-control input-transparent" placeholder="Auto create" disabled>
                                                <input name="id" type="number" value="${brand.brandID }" class="hiding hide">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" name="name" value="${brand.brandName }" id="hint-field" class="form-control input-transparent" required="required">
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-offset-3 col-sm-8">
                                                <div class="btn-toolbar">
                                                    ...
                                                    <a href="delete?brandId=${brand.brandID }" class="btn btn-danger">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-offset-3 col-md-6">
                    	<section class="widget">
                        <header>
                            <h4><i class="fa fa-align-left"></i> List <span class="fw-semi-bold">Brand</span></h4>
                        </header>
                        <div class="body">
                            <div class="mt">
                                <table id="datatable-table" class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${listBrands}">
                                            <tr>
                                                <td>${item.brandID }</td>                                            
                                                <td><span class="fw-semi-bold">${item.brandName }</span></td>                                               
                                                <td>                                               	
                                                    <a  href="edit?categoryId=${item.brandID }" class="btn btn-primary" data-placement="top" data-original-title=".btn .btn-primary">Edit</a>
                                                    <a href="delete?categoryId=${item.brandID }" class="btn btn-danger" data-placement="top" data-original-title=".btn .btn-primary">Delete</a>                            
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
